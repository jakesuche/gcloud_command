...
_Use the external IP address with the curl command to test your demo application._
...
_Now that you've seen a quick tour of Kubernetes, it's time to dive into each of the components and abstractions._
...
# Pods
_Investigate pods in more detail._

#### _Creating Pods_

_Pods can be created using pod configuration files._
